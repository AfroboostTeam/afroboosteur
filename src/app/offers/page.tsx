...
import { offerService, buildDefaultOffers } from '@/lib/database';
            ...
            {offers.map((offer, index) => {
              ...
              return (
                <motion.div
                  key={offer.id}
                  variants={item}
                  className={`${bgClass} border border-gray-700/50 rounded-xl p-6 space-y-4 shadow-inner hover:transform hover:scale-105 transition-all duration-300`}
                >
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          <select
                            ...
                            className="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-[#D91CD2] appearance-none cursor-pointer pr-8"
                          >
